...
function ShippingPolicy() {
    return (
        <div className="flex flex-col p-20 font-pt-sans">
            ...
            <p className="p-2 font-bold">1. Shipping Methods:</p>
            <p className="p-2">
            ...
            <p className="p-2 font-bold">2. Order Processing:</p>
            <ul className="list-disc pl-6">
                <li>
            ...
            <p className="p-2 font-bold">3. Shipping Costs:</p>
            ...
            <p className="p-2 font-bold">4. Estimated Delivery Times:</p>
            <p className="p-2">
            ...
            <p className="p-2 font-bold">5. International Shipping:</p>
            <p className="p-2">
            ...
            <p className="p-2 font-bold">6. Shipping Restrictions:</p>
            <p className="p-2">
            ...
            <p className="p-2 font-bold">7. Order Tracking:</p>
            <p className="p-2">
            ...
            <p className="p-2 font-bold">8. Shipping Delays:</p>
            <p className="p-2">
